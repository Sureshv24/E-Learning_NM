  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Learner outcomes on <b style={{ color: "#0056d2" }}> EduCraft</b>
        </Text>
        <Text
          fontFamily={"poppins"}
          fontSize={{
        ...
        >
          According to the latest findings from  EduCraft's 2023 report,{" "}
          <span>
            <b>an impressive 87% of learners have reported tangible career benefits.</b>
          </span> These include promotions, enhanced job performance, successful job transitions, increased employability, and skill development.  EduCraft's extensive curriculum and industry-recognized certifications have played a pivotal role in facilitating the professional growth of learners, equipping them to thrive in today's fiercely competitive job landscape."
        </Text>
        <Flex mt='15px' >
          <Button
            bgColor={"#0056d2"}
